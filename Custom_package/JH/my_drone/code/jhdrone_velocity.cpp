    ...
    // c키 입력의 명령 처리 : Rotate (현재 position x,y,z를 받고 position기반 원회전 (머리는 position을보게))
                ...
                switch(choice)
                {
                    ...
                    case 2 :
                        ...
                        duration.sleep();
                        set_local_pos_pub.publish(pos1_ori);
                        duration.sleep();
                        set_local_pos_pub.publish(pos_origin);
                        duration.sleep();
